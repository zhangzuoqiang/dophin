...
<div id="dialog-profile">
  <form action="">
    昵称：<input id="nickname" value="<?php if(isset($nickname)){echo $nickname;}?>" />
  </form>
</div>
-->
        ...
        <!--[if lt IE 9]>
            ...
            <script type="text/javascript">window.jQuery || document.write(unescape('%3Cscript src="<?php if(isset($_www_url)){echo $_www_url;}?>js/jquery-1.4.4.min.js"%3E%3C/script%3E'))</script>
        <![endif]-->
        <!--[if gte IE 9]>
            <script src="http://lib.sinaapp.com/js/jquery/1.9.0/jquery.min.js"></script>
            <script type="text/javascript">window.jQuery || document.write(unescape('%3Cscript src="<?php if(isset($_www_url)){echo $_www_url;}?>js/jquery-2.0.0b1.min.js"%3E%3C/script%3E'))</script>
        <![endif]-->
        <!--[if !IE]><!-->
            <script src="http://lib.sinaapp.com/js/jquery/1.9.0/jquery.min.js"></script>
        ...
        <script src="<?php if(isset($_www_url)){echo $_www_url;}?>js/jquery.uniform.min.js" type="text/javascript"></script>
        <link rel="stylesheet" href="<?php if(isset($_www_url)){echo $_www_url;}?>css/uniform/css/uniform.default.min.css" />
    </body>
</html>