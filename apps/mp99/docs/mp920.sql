DROP DATABASE IF EXISTS `mpcom_sql`;
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mpcom_sql` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `mpcom_sql`;
SET NAMES utf8;
...
-- 属性
--
DROP TABLE IF EXISTS `fo_attribute`;
CREATE TABLE `fo_attribute` (
...
-- 属性项
--
DROP TABLE IF EXISTS `fo_attr_item`;
CREATE TABLE `fo_attr_item` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
-- 附件列表 
--
DROP TABLE IF EXISTS `fo_attachment`;
CREATE TABLE IF NOT EXISTS `fo_attachment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 COMMENT='附件列表';
...
CREATE TABLE IF NOT EXISTS `fo_user` (
  ...
  -- 以下字段针对开放平台绑定的用户,没有与平台绑定,以下字段为空
  `open_name` varchar(50) NOT NULL default '' COMMENT '开放平台标志名:taobao,qq,sina....',
  `open_uid` int(10) unsigned NOT NULL default 0 COMMENT '开放平台上的用户ID',
  `open_username` varchar(50) NOT NULL default '' COMMENT '开放平台上的用户名',
  `accredit_time` int(10) unsigned NOT NULL default 0 COMMENT '开放平台授权时间',
  PRIMARY KEY (`uid`),
...
--
INSERT INTO `fo_user` 
﻿  (`uid`, `username`, `realname`, `password`, `status`, `gender`, `email`, `msn`, `mobile`, `address`,
﻿  `province`, `city`, `county`, `coin`, `point`, `credit`, `honor`)
VALUES 
﻿  (1, 'admin', '', '310dcbbf4cce62f762a2aaa148d556bd', 1, 1, 'mp920.com@gmail.com', '', 0, '',
﻿  350000, 350100, 350102,﻿  1000000, 100000, 100, 100);
...
-- 用户数据
--
DROP TABLE IF EXISTS `fo_user_data`;
CREATE TABLE `fo_user_data` (
  ...
  `last_visit` int(10) unsigned NOT NULL default '0' COMMENT '上次访问时间:登录状态有刷新页面都会更新此值',
  -- 用户正常退出,会将该字段置0,当直接关闭网页,不进行退出操作时,默认还是1(在线),当下次浏览页面与上次在线时间比对是否超时
  `is_online` tinyint unsigned NOT NULL default '0' COMMENT '当前是否在线,结合last_online字段配合检验',
...
/*Data for the table `fo_user_data` */
INSERT INTO `fo_user_data` VALUES 
﻿  (1, 1279034322, 0, 0, 0, 0, 0, 0, 0, 0, 1279034322);

--
-- fo_user_role
-- 用户角色
--
DROP TABLE IF EXISTS `fo_user_role`;
CREATE TABLE `fo_user_role` (
...
-- Records 
-- ----------------------------
INSERT INTO `fo_user_role` VALUES 
﻿  ('1', '1'),
﻿  ('1', '1,2');
...
-- 角色
--
DROP TABLE IF EXISTS `fo_role`;
CREATE TABLE `fo_role` (
  ...
  PRIMARY KEY  (`rid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='角色表' AUTO_INCREMENT=101;
/*Data for the table `fo_role` */
INSERT INTO `fo_role` VALUES
...
-- 权限
--
DROP TABLE IF EXISTS `fo_right`;
CREATE TABLE `fo_right` (
  ...
  PRIMARY KEY  (`rid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='角色表' AUTO_INCREMENT=1001;
/*Data for the table `fo_right` */
INSERT INTO `fo_right` VALUES
﻿  ('1', '管理员', 'admin'),
﻿  -- 各种类型网站公共权限
...
-- 留言本
--
DROP TABLE IF EXISTS `fo_guestbook`;
CREATE TABLE `fo_guestbook` (
  `id` int(10) unsigned NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='留言本';
...
-- TAG标签数据
--
DROP TABLE IF EXISTS `fo_tag_data`;
CREATE TABLE `fo_tag_data` (
...
-- 分类
--
DROP TABLE IF EXISTS `fo_category`;
CREATE TABLE `fo_category` (
  ...
  `status` TINYINT NOT NULL COMMENT  '分类状态:1-正常,-1-删除',
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分类表';
INSERT INTO `fo_category` 
﻿  (`id`, `pid`, `type`, `name`, `path`, `status`)
VALUES
﻿  (1 , 0, 'news', '公告', '/1/',  1),
﻿  (2 , 0, 'news', 'FAQ', '/2/', 1),
﻿  (3 , 0, 'news', '综合新闻', '/3/', 1),
...
﻿  (302, 102, 'brand', '钟表', '/102/302/', 1),
﻿  (303, 302, 'brand', '手表', '/102/302/303/', 1),
﻿  (304, 302, 'brand', '怀表', '/102/302/304/', 1),
﻿  (305, 302, 'brand', '挂钟', '/102/302/305/', 1),
﻿  ﻿  -- 美容化妆
...
﻿  -- 索引页链接指专题页首页的新闻等编辑添加的链接
﻿  (10011, 0, 'index_link', '索引页链接', '/1011/', 1);

--
-- fo_news
-- 新闻内容
--
DROP TABLE IF EXISTS `fo_news`;
CREATE TABLE `fo_news` (
  `id` int(10) unsigned NOT NULL auto_increment,
  ...
  `cache_file` varchar(100) NOT NULL default '' COMMENT '缓存文件路径',
  PRIMARY KEY  (`id`)
...
-- 评论内容
--
DROP TABLE IF EXISTS `fo_comments`;
...
-- 链接
-- 
DROP TABLE IF EXISTS `fo_link`;
CREATE TABLE IF NOT EXISTS `fo_link` (
  `id` int(11) NOT NULL auto_increment,
  `cid` SMALLINT NOT NULL default '1' COMMENT '所属分类ID',
  ...
  `page` SMALLINT NOT NULL default 0 COMMENT '显示的页面',
  `area` SMALLINT NOT NULL default 0 COMMENT '显示页面中的区域',
...
-- 专题
--
DROP TABLE IF EXISTS `fo_special`;
CREATE TABLE `fo_special` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
INSERT INTO `fo_special` (`id`, `cid`, `sign`, `name`, `title`, `summary`,
﻿  `domain`, `path`, `index_page`, `tpl_page`, `charge_editor`, 
﻿  `keyword`, `meta_desc`, 
﻿  `status`, `relate`, `create_time`, `post_time`) VALUES
...
﻿  (7, 302, 'iwc', '万国', '万国表（IWC）', '', '', 'html/i/iwc/', 'index.html', '', 'admin', '万国表,万国,iwc', '身为卓越不凡的钟表工程师，万国表提供顶级的技术内涵、创新思维和品牌个性', 1, '', 1307543572, 1307543572),
...
-- 品牌
--
DROP TABLE IF EXISTS `fo_brand`;
CREATE TABLE `fo_brand` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `spc_id` int unsigned NOT NULL DEFAULT 1 COMMENT '专题ID',
  `cid` SMALLINT unsigned NOT NULL DEFAULT 1 COMMENT '分类ID',
  `name` varchar(100) NOT NULL default '' COMMENT '品牌名',
  `logo` varchar(100) NOT NULL default '' COMMENT '品牌LOGO',
  `founder` varchar(100) NOT NULL default '' COMMENT '创始人',
  `found_year` char(4) NOT NULL default '' COMMENT '创建年代',
  `country` char(4) NOT NULL default '' COMMENT '国家',
...
INSERT INTO `fo_brand`
﻿  (`id`, `spc_id`, `cid`, `name`, `official_url`, `status`, `content`)
VALUES
...
-- 公司/企业类型
--
DROP TABLE IF EXISTS `fo_corp_type`;
CREATE TABLE `fo_corp_type` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `name` varchar(90) NOT NULL COMMENT '名称',
  PRIMARY KEY  (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='公司/企业类型';
insert into `fo_corp_type` (`id`, `name`)
value 
﻿  (1, '留学中介'),
﻿  (2, '留学培训学校'),
﻿  (3, '留学学校');
...
-- 公司/企业
--
DROP TABLE IF EXISTS `fo_corp`;
CREATE TABLE `fo_corp` (
  `id` int(10) unsigned NOT NULL auto_increment,
  ...
  `type` tinyint unsigned NOT NULL default '0' COMMENT '类型:1-留学中介,2-留学培训学校',
  ...
  `staff_num` SMALLINT unsigned NOT NULL DEFAULT '0' COMMENT '职员数量',
  `reg_capital` SMALLINT unsigned NOT NULL DEFAULT '0' COMMENT '注册资本(单位万)',
  ...
  `views` MEDIUMINT NOT NULL DEFAULT 0 COMMENT '企业信息被查看次数',
  `today_views` MEDIUMINT NOT NULL DEFAULT 0 COMMENT '企业信息当天被查看次数',
  `status` tinyint NOT NULL DEFAULT 0 COMMENT '状态',
  PRIMARY KEY  (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='公司/企业';
...
-- RSS源
-- 
DROP TABLE IF EXISTS `fo_rss_source`;
CREATE TABLE IF NOT EXISTS `fo_rss_source` (
  ...
  `orderid` tinyint NOT NULL COMMENT 'RSS源显示顺序',
  PRIMARY KEY  (`id`),
  KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='RSS源';
...
-- 页面内区域/模块
-- 
DROP TABLE IF EXISTS `fo_page_area`;
CREATE TABLE IF NOT EXISTS `fo_page_area` (
  `id` SMALLINT NOT NULL auto_increment,
  `page` SMALLINT NOT NULL COMMENT '页面ID',
...
-- 页面显示内容
--
DROP TABLE IF EXISTS `fo_page_content`;
CREATE TABLE `fo_page_content` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `text` VARCHAR(100) NOT NULL COMMENT '显示内容',
  `url` VARCHAR(255) NOT NULL COMMENT '链接',
  `pic` VARCHAR(255) NOT NULL COMMENT '图片',
  `desc` VARCHAR(255) NOT NULL COMMENT '描述',
  `page` SMALLINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '所属页面',
  `area` SMALLINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '页面中的区块',
  `line` SMALLINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '区块内的所处行数',
  `pos` SMALLINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '区块内的位置(一行只有一条记录时为空）',
  PRIMARY KEY (`id`),
  KEY  (`page`)
) ENGINE=InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT = '页面显示内容';

--
-- fo_media
-- 媒体内容
--
DROP TABLE IF EXISTS `fo_media`;
CREATE TABLE `fo_media` (
  `source_id` int(10) unsigned NOT NULL COMMENT '媒体的源ID,新闻等主键ID',
  `source_type` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '源类型:1-新闻,2-专题,3-链接,4-公司,5-用户',
  `local_file` varchar(255) NOT NULL COMMENT '本地硬盘的物理路径',
  `media_type` TINYINT NOT NULL COMMENT '媒体类型:1-图片,2-flash动画,3-视频,4-音频',
...
-- 商品展示
--
DROP TABLE IF EXISTS `fo_goods_show`;
CREATE TABLE `fo_goods_show` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(255) NOT NULL COMMENT '标题',
  `url` VARCHAR(255) NOT NULL COMMENT '目标链接',
  `pic` VARCHAR(255) NOT NULL COMMENT '图片',
  `price` MEDIUMINT NOT NULL COMMENT '实际价格',
  `market_price` MEDIUMINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '市场价/原价',
  `saller` VARCHAR(60) NOT NULL DEFAULT 0 COMMENT '商家',
  `source` VARCHAR(30) NOT NULL DEFAULT 0 COMMENT '来源网站',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT = '商品展示';
...
-- 行政区划
--
DROP TABLE IF EXISTS `fo_xzqh`;
CREATE TABLE `fo_xzqh` (
  `id` SMALLINT unsigned NOT NULL auto_increment,
  `pid` SMALLINT unsigned NOT NULL COMMENT '上级行政区ID',
...
--
-- fo_redirect_log
-- 跳转日志（所有通过redirect.php跳转的页面记录）
--
DROP TABLE IF EXISTS `fo_redirect_log`;
CREATE TABLE `fo_redirect_log` (
  `id` SMALLINT unsigned NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='跳转日志';
DROP DATABASE IF EXISTS `mpcom_sql`;
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mpcom_sql` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `mpcom_sql`;
SET NAMES utf8;
