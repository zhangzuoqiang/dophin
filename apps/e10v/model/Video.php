...
class Model_Video extends Model
{
	 ...
	 * @var string
	 */
	public $tbl_content = 'video_content';
	/**
	 ...
	 * @var string
	 */
	public $saveContentPath = 'video';
	/**
	 * 保存视频简介，静态页等相关文件路径的ID基数
	 * @var int
	 */
	...
	public function __construct($id=0) 
	{
		...
		$this->saveContentType = $GLOBALS['_save_video_content_type'];
		$this->saveContentPath = $GLOBALS['_save_video_content_path'];
		parent::__construct();
	}
